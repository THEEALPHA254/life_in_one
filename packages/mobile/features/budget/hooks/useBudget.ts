// Mirrors packages/web/src/features/budget/hooks/useBudget.ts — same TanStack
// keys via @lio/core. Amount convention: positive-only `amount_cents`; the
// category `kind` decides income/expense/savings signage in all calculations.
